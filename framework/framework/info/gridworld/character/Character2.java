...
{
    protected Grid<Character2> grid;
...
public abstract void attack();
     ...
     */
    public Grid<Character2> getGrid()
    {
        return grid;
    }
     ...
     */
    public void putSelfInGrid( Grid<Character2> gr, Location loc )
    {
        if ( grid != null )
            throw new IllegalStateException( "This character is already contained in a grid. " );

        Character2 character = gr.get( loc );
        if ( character != null )
    ...
    public Location moveTo( Location newLocation )
    {
        ...
        Character2 other = grid.get( newLocation );
        if ( other != null )
