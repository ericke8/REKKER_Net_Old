...
public class GUIController<T>
{
    ...
    private JButton moveButton, attackButton, endButton;
     ...
     */
    public void step()// TODO corresponds with move
    {
     ...
     * stopped.
     */
    public void run()// TODO corresponds with attack
    {
    ...
    private void makeControls()
    {
        ...
        attackButton = new JButton( new String( "Attack" ) );
        ...
        Dimension spacer = new Dimension( 10, moveButton.getPreferredSize().height + 10 );
        Dimension largeSpacer = new Dimension( 200, moveButton.getPreferredSize().height + 10 );
        ...
        moveButton.addActionListener( new ActionListener()
        {
            ...
            {
                step();//TODO unit selection and stuff
            }
        } );
